...
###
conan export-pkg . DeepLearningCPP/0.1@bughero/Testing --force -pr=default
rm -rf test_package/build && conan test test_package DeepLearningCPP/0.1@bughero/Testing
# rm -rf test_package/build && conan test test_package DeepLearningCPP/0.1@bughero/Testing --build=DeepLearningCPP
